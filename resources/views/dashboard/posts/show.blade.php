    ...
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
        <article class="mx-auto w-full max-w-4xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <header class="mb-4 lg:mb-6 not-format">
              ...
              <a href="#" class="btn btn-warning font-medium text-sm text-blue-600 hover:underline"><i class="bi bi-pencil"></i>Edit</a>
              <a href="#" class="btn btn-danger font-medium text-sm text-blue-600 hover:underline"><i class="bi bi-trash"></i>Delete</a>
